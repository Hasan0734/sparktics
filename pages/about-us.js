      ...
      <Layout>
        ...
        <div className="max-w-[1448px] mx-auto bg-white px-6 md:px-[112px] py-[52px]">
          <div className="">
            ...
            <div className="mt-11">
              <div className="bg-[#EFF9FF] max-w-[843px] mx-auto py-[56px] rounded-md">
              ...
              <div className="mt-[200px] grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-[170px]">
                <div>
                  <div className="bg-[#E6F5FD] p-10 w-[208px] rounded-md">
                    <svg
                      width="120"
                      height="120"
                      viewBox="0 0 120 120"
                  ...
                  <h2 className="font-bold text-[24px] leading-[29px] text-[#00588A] mt-8">
                    Our Mission
                  </h2>
                  <p className="font-normal text-[16px] leading-[24px] text-[#00588A] mt-2">
